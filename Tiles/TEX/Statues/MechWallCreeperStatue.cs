...
namespace FactoryMod.Tiles.TEX.Statues
{
	public class MechWallCreeperStatue : ModTile
	{
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Wall Creeper Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechWallCreeperStatueItem>());
		}
	...
	public class MechWallCreeperStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Wall Creeper Statue");
		...
		public override void SetDefaults() {
			...
			item.createTile = TileType<MechWallCreeperStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.WallCreeperStatue, 1);
			recipe.AddIngredient(ItemID.SpiderBanner, 1);
