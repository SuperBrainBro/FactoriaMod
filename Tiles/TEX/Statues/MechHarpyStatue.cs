...
{
	public class MechHarpyStatue : ModTile
	{
		...
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Harpy Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechHarpyStatueItem>());
		}
		...
		public override void HitWire(int i, int j)
		{
			if (GetInstance<FactoryModWorld>().worldTEX >= TEXCost)
			{
				...
				{
					npcIndex = NPC.NewNPC(spawnX, spawnY - 12, NPCID.Harpy);
				}
				if (npcIndex >= 0)
				{
	...
	public class MechHarpyStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Harpy Statue");
		...
		public override void SetDefaults() {
			...
			item.createTile = TileType<MechHarpyStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.HarpyStatue, 1);
