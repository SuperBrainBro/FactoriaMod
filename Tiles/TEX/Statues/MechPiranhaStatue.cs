...
{
	public class MechPiranhaStatue : ModTile
	{
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Piranha Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechPiranhaStatueItem>());
		}
		...
		public override void HitWire(int i, int j)
		{
			...
			{
				npcIndex = NPC.NewNPC(spawnX, spawnY - 12, NPCID.Piranha);
			}
			if (npcIndex >= 0)
			{
	...
	public class MechPiranhaStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Piranha Statue");
		...
		public override void SetDefaults() {
			...
			item.createTile = TileType<MechPiranhaStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.PiranhaStatue, 1);
