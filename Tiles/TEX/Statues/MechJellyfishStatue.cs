...
namespace FactoryMod.Tiles.TEX.Statues
{
	public class MechJellyfishStatue : ModTile
	{
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Jellyfish Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechJellyfishStatueItem>());
		}
	...
	public class MechJellyfishStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Jellyfish Statue");
		...
		public override void SetDefaults() {
			...
			item.createTile = TileType<MechJellyfishStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.JellyfishStatue, 1);
