...
{
	public class MechDripplerStatue : ModTile
	{
		...
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Drippler Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechDripplerStatueItem>());
		}
		...
		public override void HitWire(int i, int j)
		{
			if (GetInstance<FactoryModWorld>().worldTEX >= TEXCost)
			{
				...
				{
					npcIndex = NPC.NewNPC(spawnX, spawnY - 12, NPCID.Drippler);
				}
				if (npcIndex >= 0)
				{
	...
	public class MechDripplerStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Drippler Statue");
		...
		public override void SetDefaults() {
			...
			item.createTile = TileType<MechDripplerStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.DripplerStatue, 1);
