...
{
	public class MechMedusaStatue : ModTile
	{
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Medusa Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechMedusaStatueItem>());
		}
		...
		public override void HitWire(int i, int j)
		{
			...
			{
				npcIndex = NPC.NewNPC(spawnX, spawnY - 12, NPCID.Medusa);
			}
			if (npcIndex >= 0)
			{
	...
	public class MechMedusaStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Medusa Statue");
		...
		public override void SetDefaults() {
			...
			item.createTile = TileType<MechMedusaStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.MedusaStatue, 1);
			recipe.AddIngredient(ItemID.MedusaHead, 1);
