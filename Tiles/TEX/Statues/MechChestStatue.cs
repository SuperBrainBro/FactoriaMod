...
namespace FactoryMod.Tiles.TEX.Statues
{
	public class MechChestStatue : ModTile
	{
		...
		public override void SetDefaults() {
			...
			name.SetDefault("Mechanical Chest Statue");
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(i * 16, j * 16, 32, 48, ItemType<MechChestStatueItem>());
		}
	...
	public class MechChestStatueItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Mechanical Chest Statue");
			Tooltip.SetDefault("Can be activated with wire.\nConsumes 86 T.E.X. per activation.\nMonster's regular loot table is not affected.\nSpawns all variants of the monster.");
		}

		public override void SetDefaults() {
			item.CloneDefaults(ItemID.ArmorStatue);
			item.createTile = TileType<MechChestStatue>();
			item.placeStyle = 0;
		}
        ...
        public override void AddRecipes()
        {
			...
			recipe.AddIngredient(ItemID.ChestStatue, 1);
