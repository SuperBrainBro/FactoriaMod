...
namespace FactoryMod.Items.Other
{
    public class SimpleItem : ModItem
    {       
        public SimpleItem(Mod mod, string name)
        {
        ...
        {
            Main.itemTexture[item.type] = GetTexture(Texture);
        }

        public static SimpleItem MakePlaceable(Mod mod, string name, int placeType, int width = 16, int height = 16, int placeStyle = 0, int value = 50000)
        {
            SimpleItem i = new SimpleItem(mod, name);
